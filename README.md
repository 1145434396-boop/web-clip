...
把网页（微信公众号 / 飞书 Wiki / 知乎 / 小红书 / 普通博客）一键抓成 **Markdown 原文 + 本地图片**，落地到你指定的目录。专为 AI agent skill 场景设计：**正文提取全程本地完成，不把内容喂给 LLM 二次处理**，图文位置精确对应。
...
- **本地提取**：HTML→Markdown、图片下载全在本地 Python 跑，正文不经过 LLM
