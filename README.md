...
把网页（微信公众号 / 飞书 Wiki·文档 / 知乎 / 小红书 / 普通博客）一键抓成 **Markdown 原文 + 本地图片**，落到你指定的目录。专为 AI agent skill 设计，图文位置精确还原。
...
- **本地提取**：HTML→Markdown、图片下载都在本地 Python 完成
...
> 经验：剪藏只是第一步。如果落到本地后还要接**与 AI 协作的后续流程**（整理、分析、归档入库、二次生成等），建议直接用 skill——它和 Claude / agent 在同一上下文里，剪藏完能无缝衔接后续处理，不必在浏览器和工具之间来回倒腾。
